...
describe('Phase 5 Eval – Validation Matrix', () => {
  describe('Live API Validations (V1-V5)', () => {
    ...
    it(
      'V1: SPARQL endpoint is reachable via POST and returns results with bindings',
      async () => {
    ...
    it(
      'V2: AI Act findable – result contains celex starting with "32024R1689"',
      async () => {
    ...
    it(
      'V3: DSGVO findable – result contains celex "32016R0679"',
      async () => {
    ...
    it(
      'V4: AI Act fulltext DE – content.length > 10000',
      async () => {
    ...
    it(
      'V5: AI Act fulltext EN – content.length > 10000',
      async () => {
  ...
  describe('Server Validations (V16-V18, V20, V22)', () => {
    ...
    it('V20: two createServer calls return different instances', async () => {
      ...
      expect(tools1.map((t) => t.name).sort()).toEqual(expectedTools);
      expect(tools2.map((t) => t.name).sort()).toEqual(expectedTools);
    });
